...
export function WorkspaceSidebar() {
  ...
  return (
    ...
    >
      <nav className="flex flex-1 flex-col gap-0.5 py-3" aria-label="Workspaces">
        {DASHBOARD_WORKSPACE_NAV.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "controller-nav-item flex items-center gap-3 border-l-4 px-5 py-3 text-left text-xs font-medium transition-all",
                active && "active",
                active

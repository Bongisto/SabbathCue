...
// Hymn themes — applied only when a hymn is the live item (see broadcast-store
// resolveOutputThemeId). "Classic Teal" matches the SDA hymnal PowerPoint look
// (teal gradient, white outlined title, cream reference); the other four are
// modern alternatives. All use existing BroadcastTheme fields — no header band.
const HYMNAL_CLASSIC_TEAL: BroadcastTheme = {
  ...CLASSIC_DARK,
  id: "builtin-hymnal-classic-teal",
  name: "Hymnal Classic Teal",
  background: {
    type: "gradient",
    color: "#0f5e5a",
    gradient: {
      ...
      angle: 135,
      stops: [
        { color: "#0f5e5a", position: 0 },
        { color: "#13324f", position: 100 },
      ],
    },
    image: null,
  },
  ...
  verseText: {
    ...
    color: "#ffffff",
    lineHeight: 1.3,
    shadow: { color: "rgba(0,0,0,0.55)", blur: 8, x: 2, y: 3 },
    outline: { color: "#0a1f2e", width: 6 },
  },
  verseNumbers: { visible: false, fontSize: 18, color: "#f5e6b8", superscript: true },
  reference: {
    ...CLASSIC_DARK.reference,
    fontFamily: "Geist Variable",
    fontSize: 44,
...
const HYMNAL_MIDNIGHT: BroadcastTheme = {
  ...HYMNAL_CLASSIC_TEAL,
  id: "builtin-hymnal-midnight",
  name: "Hymnal Midnight",
  background: { type: "solid", color: "#0b1220", gradient: null, image: null },
  verseText: {
    ...HYMNAL_CLASSIC_TEAL.verseText,
    fontSize: 74,
    fontWeight: 600,
    outline: null,
    shadow: { color: "rgba(0,0,0,0.6)", blur: 10, x: 0, y: 2 },
  },
  reference: { ...HYMNAL_CLASSIC_TEAL.reference, color: "#facc15" },
}

const HYMNAL_PAPER: BroadcastTheme = {
  ...HYMNAL_CLASSIC_TEAL,
  id: "builtin-hymnal-paper",
  name: "Hymnal Paper",
  background: { type: "solid", color: "#fbfaf6", gradient: null, image: null },
  verseText: {
    ...HYMNAL_CLASSIC_TEAL.verseText,
...
const HYMNAL_ROYAL: BroadcastTheme = {
  ...HYMNAL_CLASSIC_TEAL,
  id: "builtin-hymnal-royal",
  name: "Hymnal Royal",
  background: {
    type: "gradient",
    color: "#1e3a8a",
  ...
  verseText: {
    ...
    fontWeight: 600,
    outline: null,
    shadow: { color: "rgba(0,0,0,0.5)", blur: 12, x: 0, y: 3 },
  },
  reference: { ...HYMNAL_CLASSIC_TEAL.reference, color: "#bae6fd" },
}

const HYMNAL_BIG_LYRICS: BroadcastTheme = {
  ...HYMNAL_CLASSIC_TEAL,
  id: "builtin-hymnal-big-lyrics",
  name: "Hymnal Big Lyrics",
  background: { type: "solid", color: "#111111", gradient: null, image: null },
  verseText: {
    ...HYMNAL_CLASSIC_TEAL.verseText,
    fontSize: 88,
    ...
    lineHeight: 1.2,
    outline: null,
    shadow: { color: "rgba(0,0,0,0.6)", blur: 8, x: 0, y: 2 },
  },
  verseNumbers: { visible: false, fontSize: 16, color: "#ffffff", superscript: true },
  reference: {
    ...HYMNAL_CLASSIC_TEAL.reference,
    fontSize: 34,
    color: "#34d399",
  ...
  layout: { ...HYMNAL_CLASSIC_TEAL.layout, textAreaHeight: 84, referenceGap: 24 },
}

/** Default theme used when a hymn is live and the operator has not chosen one. */
export const DEFAULT_HYMN_THEME_ID = "builtin-hymnal-classic-teal"

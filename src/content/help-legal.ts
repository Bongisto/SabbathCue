...
export const HELP_GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Kinetic Themes - animated live-output scenes with motion backgrounds for verses and hymns.",
  ...
  },
  {
    ...
    items: [
      ...
      "Speech Recognition - pick Vosk (offline), Deepgram, or Gladia, and save cloud API keys.",
      ...
      "API Keys - see at a glance whether Deepgram and Gladia keys are configured.",

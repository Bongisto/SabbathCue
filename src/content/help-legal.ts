...
export const HELP_GUIDE_SECTIONS = [
  {
    ...
    items: [
      ...
      "Use Vosk for fully offline transcription, or Deepgram when you have a stable internet connection and API key.",
      "Detected verses appear in the queue — review, edit, and send them to your broadcast output.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "Online (Deepgram): higher accuracy in noisy rooms. Requires your own API key and an active internet connection.",
      "Speak Bible references clearly — book, chapter, and verse — for the best detection results.",
    ],
  },
  {

...
| `quantize:model` | Re-run the Qwen3 ONNX export and INT8 quantization |
| `download:whisper` | Download `ggml-tiny.en.bin` for the optional legacy Whisper STT feature |
...
| Reinstall the optional legacy Whisper model | `bun run download:whisper` |
